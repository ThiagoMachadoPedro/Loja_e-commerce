...
import br.com.lojavirtual.th.enums.TipoEndereco;
...
public class Endereco implements Serializable {
	...
	@JoinColumn(name = "pessoa_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "pessoa_fk")) // para
																																		// usar
																																		// a
																																		// Classe
																																		// Pessoa
	...
	@Enumerated(EnumType.STRING) // chama o enum para dentro dessa class E PASSAR QUE É UM sTRING
