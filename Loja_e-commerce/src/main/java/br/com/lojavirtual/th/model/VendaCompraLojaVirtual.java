...
public class VendaCompraLojaVirtual implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name = "end_cobran_id", nullable = false, 
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "end_cobran_fk"))
	...
	private CupomDesconto cupomDesc;
	@Column(nullable = false)
	...
	public CupomDesconto getCupomDesc() {
		return cupomDesc;
	}
	public void setCupomDesc(CupomDesconto cupomDesc) {
